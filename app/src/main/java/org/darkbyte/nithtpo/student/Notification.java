...
String ab="android.R.drawable."+home_post.getSmall_icon();
        ...
        if (home_post.getSmall_icon() == null || home_post.getSmall_icon().isEmpty() || home_post.getSmall_icon().length() == 0) {
            Glide.with(context).load(R.drawable.gg).into(holder.small_icon);
        } else {
            Glide.with(context).load(R.drawable.gg).asBitmap().diskCacheStrategy(DiskCacheStrategy.SOURCE).error(R.drawable.gg).into(new ImageViewTarget<Bitmap>(holder.small_icon) {
                @Override
        ...
        holder.lay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                assign.putString("title",home_post.getTitle());
                assign.putString("body",home_post.getBody());
                assign.putString("bigpicture",home_post.getBigpicture());
